...
ConfigManager.prototype.set = function (config) {
    ...
    _.merge(this._config, {
        ...
        slugs: {
            ...
            reserved: ['admin', 'app', 'apps', 'archive', 'archives', 'blog', 'categories', 'category', 'dashboard', 'feed', 'ghost-admin', 'login', 'logout', 'page', 'pages', 'post', 'posts', 'public', 'register', 'setup', 'signin', 'signout', 'signup', 'user', 'users', 'wp-admin', 'wp-login'],
            protected: ['ghost', 'rss']
        },
        uploads: {
